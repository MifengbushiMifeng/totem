...
public class DelayUnits {
    ...
    public final static be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.DelayUnits Ï_S = new be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.DelayUnits(_Ï_S);
