                ...
                switch (state) {
                    ...
                    case  8 :
                        if (("param" == ___local)&&("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be" == ___uri)) {
                            _getParam().add(((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamImpl) spawnChildFromEnterElement((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("param" == ___local)&&("http://jaxb.model.scenario.totem.run.montefiore.ulg.ac.be" == ___uri)) {
                ...
                switch (state) {
                    ...
                    case  9 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getParam().add(((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamTypeImpl) spawnChildFromEnterAttribute((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ParamTypeImpl.class), 10, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :
