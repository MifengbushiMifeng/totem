...
public class LspsImpl implements nl.tudelft.repository.externalRouting.routing.model.jaxb.Lsps, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (nl.tudelft.repository.externalRouting.routing.model.jaxb.Lsps.class);
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new nl.tudelft.repository.externalRouting.routing.model.jaxb.impl.LspsImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            context.startElement("http://jaxb.model.routing.externalRouting.repository.tudelft.nl", "lsp");
            int idx_0 = idx1;
...
+"\u0000~\u0000\u001fxq\u0000~\u0000\u001at\u0000<nl.tudelft.repository.externalRouting.routing.m"
+"odel.jaxb.Lspt\u0000+http://java.sun.com/jaxb/xjc/dummy-elementss"
...
+"/2001/XMLSchema-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0003lspt\u0000?http://jaxb.mode"
+"l.routing.externalRouting.repository.tudelft.nlq\u0000~\u0000\u001dsr\u0000\"com."
...
+"\u0000\u0006\u0001pq\u0000~\u0000\u0013q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000\u0005q\u0000~\u0000#q\u0000~\u0000\bx"));
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return nl.tudelft.repository.externalRouting.routing.model.jaxb.impl.LspsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("id" == ___local)&&("http://jaxb.model.routing.externalRouting.repository.tudelft.nl" == ___uri)) {
                            _getLsp().add(((nl.tudelft.repository.externalRouting.routing.model.Lsp) spawnChildFromEnterElement((nl.tudelft.repository.externalRouting.routing.model.Lsp.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
