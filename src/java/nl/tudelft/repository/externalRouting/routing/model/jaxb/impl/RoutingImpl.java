...
public class RoutingImpl implements nl.tudelft.repository.externalRouting.routing.model.jaxb.Routing, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{
    ...
    protected com.sun.xml.bind.util.ListImpl _Route;
    ...
    protected com.sun.xml.bind.util.ListImpl _getRoute() {
        if (_Route == null) {
            _Route = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Route;
    }
    ...
    public boolean isSetRoute() {
        return ((_Route == null)?false:_Route.isModified());
    }

    public void unsetRoute() {
        if (_Route!= null) {
            _Route.clear();
            _Route.setModified(false);
        }
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((_Route == null)? 0 :_Route.size());
        while (idx2 != len2) {
            context.startElement("http://jaxb.model.routing.externalRouting.repository.tudelft.nl", "route");
            int idx_0 = idx2;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Route.get(idx_0 ++)), "Route");
            context.endNamespaceDecls();
            int idx_1 = idx2;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Route.get(idx_1 ++)), "Route");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Route.get(idx2 ++)), "Route");
            context.endElement();
        }
    }
...
+"paceURIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000>nl.tudelft.repository.externalRouting.r"
+"outing.model.jaxb.Routet\u0000+http://java.sun.com/jaxb/xjc/dummy"
+"-elementssq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0015q\u0000~\u0000\fpsr\u0000\u001bcom.sun.msv.grammar.DataExp"
...
+"www.w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0005routet\u0000?http"
+"://jaxb.model.routing.externalRouting.repository.tudelft.nlq"
+"\u0000~\u0000\u001esq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0015q\u0000~\u0000\fpsq\u0000~\u0000&ppsr\u0000#com.sun.msv.datatype.xsd"
+".StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000+q\u0000~\u00000t\u0000\u0006stringsr"
+"\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00003\u0001q\u0000~\u00006sq\u0000~\u00007q\u0000~\u0000Dq\u0000~\u00000sq\u0000~\u0000\u001ft\u0000\u0004namet\u0000\u0000q\u0000~\u0000\u001esr\u0000\"c"
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("src" == ___local)&&("http://jaxb.model.routing.externalRouting.repository.tudelft.nl" == ___uri)) {
                            _getRoute().add(((nl.tudelft.repository.externalRouting.routing.model.Route) spawnChildFromEnterElement((nl.tudelft.repository.externalRouting.routing.model.Route.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  6 :
