...
public class LoadExternalRoutingTypeImpl
    extends be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl
    implements nl.tudelft.repository.externalRouting.scenario.model.jaxb.LoadExternalRoutingType, com.sun.xml.bind.JAXBObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallableObject, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.XMLSerializable, be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.ValidatableObject
{

    protected java.lang.String _LlcId;
    protected java.lang.String _RoutingFile;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (nl.tudelft.repository.externalRouting.scenario.model.jaxb.LoadExternalRoutingType.class);
    }
    ...
    public java.lang.String getRoutingFile() {
        return _RoutingFile;
    }

    public void setRoutingFile(java.lang.String value) {
        _RoutingFile = value;
    }

    public boolean isSetRoutingFile() {
        return (_RoutingFile!= null);
    }

    public void unsetRoutingFile() {
        _RoutingFile = null;
    }
    ...
    public be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingEventHandler createUnmarshaller(be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.UnmarshallingContext context) {
        return new nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.startAttribute("", "routingFile");
        try {
            context.text(((java.lang.String) _RoutingFile), "RoutingFile");
        } catch (java.lang.Exception e) {
            be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endAttribute();
...
+"\u0000\"sq\u0000~\u0000#q\u0000~\u00009q\u0000~\u00004sq\u0000~\u0000%t\u0000\u0004TMIDq\u0000~\u0000)q\u0000~\u0000+sq\u0000~\u0000\tppsq\u0000~\u0000\u000bq\u0000~\u0000\u000f"
...
+"#q\u0000~\u0000kq\u0000~\u0000\u001csq\u0000~\u0000%t\u0000\u0005llcIdq\u0000~\u0000)q\u0000~\u0000+sq\u0000~\u0000\u000bppq\u0000~\u0000hsq\u0000~\u0000%t\u0000\u000brou"
+"tingFileq\u0000~\u0000)sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
...
+"r/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000-q\u0000~\u0000\u0007q\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\u0006q\u0000~\u0000^q\u0000~\u0000f"
+"q\u0000~\u0000\nx"));
        }
        ...
        extends be.ac.ulg.montefiore.run.totem.util.jaxb.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        return ;
                    case  3 :
                        attIdx = context.getAttribute("", "routingFile");
                        if (attIdx >= 0) {
                            final java.lang.String v = context.eatAttribute(attIdx);
                            eatText2(v);
                            state = 6;
                    ...
                    case  6 :
                        ...
                        spawnHandlerFromEnterElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        spawnHandlerFromLeaveElement((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  7 :
                        ...
                        return ;
                    case  3 :
                        if (("routingFile" == ___local)&&("" == ___uri)) {
                            state = 4;
                            return ;
                        }
                        break;
                    case  6 :
                        if (("TMID" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        spawnHandlerFromLeaveAttribute((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this).new Unmarshaller(context)), 7, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  6 :
                            ...
                            spawnHandlerFromText((((be.ac.ulg.montefiore.run.totem.scenario.model.jaxb.impl.ASTMEventTypeImpl)nl.tudelft.repository.externalRouting.scenario.model.jaxb.impl.LoadExternalRoutingTypeImpl.this).new Unmarshaller(context)), 7, value);
                            return ;
                    }
